...
INSERT INTO "new_Fax" ("company_id", "company_phone", "created_at", "fax_number", "id", "image_url", "notes", "property_id", "sent_at", "status", "unlock_method", "updated_at", "user_id", "visit_date", "visit_time") SELECT "company_id", "company_phone", "created_at", "fax_number", "id", "image_url", "notes", "property_id", "sent_at", "status", "unlock_method", "updated_at", "user_id", "visit_date", "visit_time" FROM "Fax";
DROP TABLE "Fax";
